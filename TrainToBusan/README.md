...
- helping organize the project into clear game-state, update, rendering, input, and testable helper logic,
...
## IMPORTANT NOTE
- Please, make sure to expand your terminal window when playing the game. This avoids certain 
inconveniences that comes as part of the CLI-based interface.